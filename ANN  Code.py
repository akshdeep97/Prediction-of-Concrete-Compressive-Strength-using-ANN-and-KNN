...
X_train2=np.delete(X_train,6,1)
X_test2=np.delete(X_test,6,1)
classifier.fit(X_train2, Y_train, batch_size = 10, epochs = 1000, verbose=2)
classifier.evaluate(X_train2,Y_train, batch_size = 10, verbose=1)
classifier.evaluate(X_test2,Y_test, batch_size = 10, verbose=1)
